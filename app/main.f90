program main 
    ...
    double precision,external::praxis_n, newton 
    
    OPEN (unit=333,file='pruebas.OUT',form='FORMATTED')
    call leer_input_flash()

    
!     write(*,*) conversion()
    
    ! prueba conversion vs w%
    !do i=0, 50
    !    z(4) = i
      !  write(*,*) i, conversion()
    !enddo
    ...
    !x(2) = 70
    !X(3) = 300
    !fobj =.true. !se llama desde main
    FMIN = praxis_n ( 3.D-5, 10.D0, variables, 3, x, f_n )
